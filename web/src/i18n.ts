...
const ja = {
  ...
  "projects.duplicate": "複製する",
  "projects.delete": "削除する",
  ...
  "projects.hint": "複数のプロジェクトを行き来できます。上の切り替えからも選べます。",
...
const en: Dictionary = {
  ...
  "projects.hint":
    "You can keep several projects side by side and switch between them from the header.",
