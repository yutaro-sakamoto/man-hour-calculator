...
const ja = {
  ...
  "file.savedAll": "{count} 件のプロジェクトを 1 つのファイルに保存しました。",
  "file.importedMany": "{name} から {count} 件のプロジェクトを読み込みました。",
  ...
  "comments.attach": "ファイルを添付",
  "comments.needBody": "本文を書いてください (添付だけでは書き込めません)。",
  "comments.attachHint":
    "1 コメントにつき {count} 件、1 件 {size} まで。貼り付けと drop でも付けられます",
  "comments.detach": "{name} を外す",
  "comments.reject.tooMany": "{name}: 添付は 1 コメントにつき 5 件までです。",
  "comments.reject.tooLarge": "{name}: 1 件 1 MB までです。",
  "comments.reject.noRoom": "{name}: 保存できる容量が足りません。先に書き出して整理してください。",
  "comments.reject.unreadable": "{name}: 読み込めませんでした。",
  "comments.write": "書く",
  ...
  "sched.rowHeading": "タスクごとの見通し",
  "sched.rowNote": "並びは上の帯グラフと同じです。タスク名を押すと詳細が開きます。",
  "sched.remainingCol": "残り",
  "progress.heading": "進捗",
  "progress.spent": "消化",
  "progress.remaining": "残り",
  "progress.total": "全体",
  "progress.done": "完了",
  "progress.doneOf": "{done} / {count} 件",
  "progress.elapsed": "期間の経過",
  "progress.note": "消化工数 ÷ (消化 + 残り)。件数ではなく工数で重み付けしています。",
  "detail.forecast": "見通し",
  "detail.edit": "編集",
  "detail.children": "配下のタスク",
  "detail.close": "詳細を閉じる",
  "detail.previous": "前のタスク",
  "detail.next": "次のタスク",
  "detail.group": "グループ",
...
const en: Dictionary = {
  ...
  "file.savedAll": "Saved {count} projects into one file.",
  "file.importedMany": "Imported {count} projects from {name}.",
  ...
  "comments.attach": "Attach files",
  "comments.needBody": "Write something first (attachments alone are not enough).",
  "comments.attachHint": "Up to {count} files per comment, {size} each. Paste or drop works too",
  "comments.detach": "Remove {name}",
  "comments.reject.tooMany": "{name}: up to 5 files per comment.",
  "comments.reject.tooLarge": "{name}: up to 1 MB per file.",
  "comments.reject.noRoom":
    "{name}: not enough room left. Save to a file and clear some space first.",
  "comments.reject.unreadable": "{name}: could not be read.",
  ...
  "sched.rowHeading": "Task by task",
  "sched.rowNote": "Same order as the chart above. Click a task name to open its details.",
  "sched.remainingCol": "Remaining",
  "progress.heading": "Progress",
  "progress.spent": "Spent",
  "progress.remaining": "Remaining",
  "progress.total": "Total",
  "progress.done": "Finished",
  "progress.doneOf": "{done} of {count}",
  "progress.elapsed": "Time elapsed",
  "progress.note": "Spent \u00f7 (spent + remaining). Weighted by effort, not by task count.",
  "detail.forecast": "Forecast",
  "detail.edit": "Edit",
  "detail.children": "Child tasks",
  "detail.close": "Close details",
  "detail.previous": "Previous task",
  "detail.next": "Next task",
  "detail.group": "Group",
  "detail.open": "Open details for {name}",
